...
public class VisiMisiFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_visi_misi, container, false);

        String url = "http://jerman.fib.unpad.ac.id/profil/visi-misi/";

        view = (WebView) rootView.findViewById(R.id.visimisiWeb);

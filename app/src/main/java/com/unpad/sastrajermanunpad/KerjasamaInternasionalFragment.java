...
public class KerjasamaInternasionalFragment extends Fragment {

    public KerjasamaInternasionalFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_kerjasama_internasional, container, false);
        String url = "http://jerman.fib.unpad.ac.id/program/hubungan-kerjasama/tingkat-international/";

        view = (WebView) rootView.findViewById(R.id.kerjasamaInternasionalWeb);

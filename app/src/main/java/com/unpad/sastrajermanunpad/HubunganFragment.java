...
public class HubunganFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_hubungan, container, false);
        String url = "http://jerman.fib.unpad.ac.id/program/hubungan-kerjasama/";

        view = (WebView) rootView.findViewById(R.id.hubunganWeb);

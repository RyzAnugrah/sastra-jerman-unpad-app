...
public class PrestasiMahasiswaFragment extends Fragment {

    public PrestasiMahasiswaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_prestasi_mahasiswa, container, false);
        String url = "http://jerman.fib.unpad.ac.id/sertifikat-prestasi/";

        view = (WebView) rootView.findViewById(R.id.prestasiMahasiswaWeb);

...
public class LulusanFragment extends Fragment {

    public LulusanFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_lulusan, container, false);

        String url = "http://jerman.fib.unpad.ac.id/profil/profil-lulusan/";

        view = (WebView) rootView.findViewById(R.id.lulusanWeb);

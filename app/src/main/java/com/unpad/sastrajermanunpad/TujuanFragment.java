...
public class TujuanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_tujuan, container, false);

        String url = "http://jerman.fib.unpad.ac.id/profil/tujuan/";

        view = (WebView) rootView.findViewById(R.id.tujuanWeb);

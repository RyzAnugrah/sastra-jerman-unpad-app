...
public class PembinaanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_pembinaan, container, false);
        String url = "http://jerman.fib.unpad.ac.id/program/pembinaan-soft-skills/";

        view = (WebView) rootView.findViewById(R.id.pembinaanWeb);

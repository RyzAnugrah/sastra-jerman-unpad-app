...
public class StafFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_staf, container, false);
        String url = "http://jerman.fib.unpad.ac.id/staf-pengajar/";

        view = (WebView) rootView.findViewById(R.id.stafWeb);

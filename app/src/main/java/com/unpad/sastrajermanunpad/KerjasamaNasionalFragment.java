...
public class KerjasamaNasionalFragment extends Fragment {

    public KerjasamaNasionalFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_kerjasama_nasional, container, false);
        String url = "http://jerman.fib.unpad.ac.id/program/hubungan-kerjasama/tingkat-nasional/";

        view = (WebView) rootView.findViewById(R.id.kerjasamaNasionalWeb);

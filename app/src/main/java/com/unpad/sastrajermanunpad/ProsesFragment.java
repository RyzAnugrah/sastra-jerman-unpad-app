...
public class ProsesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String url = "http://jerman.fib.unpad.ac.id/program/alur-proses-pengembangan-kurikulum-2016-program-studi-sastra-jerman/";

        view = (WebView) rootView.findViewById(R.id.prosesWeb);

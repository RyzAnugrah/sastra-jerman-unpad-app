...
public class KompetensiLainFragment extends Fragment {

    public KompetensiLainFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_kompetensi_lain, container, false);

        String url = "http://jerman.fib.unpad.ac.id/kompetensi-program-studi-sastra-jerman/kompetensi-lain/";

        view = (WebView) rootView.findViewById(R.id.kompetensiLainWeb);

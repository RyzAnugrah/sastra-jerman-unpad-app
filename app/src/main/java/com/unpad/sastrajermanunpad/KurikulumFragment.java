...
public class KurikulumFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_kurikulum, container, false);
        String url = "http://jerman.fib.unpad.ac.id/program/kurikulum/";

        view = (WebView) rootView.findViewById(R.id.kurikulumWeb);

...
public class KuliahFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_kuliah, container, false);
        String url = "http://jerman.fib.unpad.ac.id/program/kurikulum/mata-kuliah/";

        view = (WebView) rootView.findViewById(R.id.kuliahWeb);

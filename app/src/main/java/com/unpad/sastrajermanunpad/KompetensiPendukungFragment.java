...
public class KompetensiPendukungFragment extends Fragment {

    public KompetensiPendukungFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_kompetensi_pendukung, container, false);

        String url = "http://jerman.fib.unpad.ac.id/kompetensi-program-studi-sastra-jerman/kompetisi-pendukung/";

        view = (WebView) rootView.findViewById(R.id.kompetensiPendukungWeb);

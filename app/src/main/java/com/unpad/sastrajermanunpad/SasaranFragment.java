...
public class SasaranFragment extends Fragment {

    public SasaranFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_sasaran, container, false);

        String url = "http://jerman.fib.unpad.ac.id/profil/sasaran-dan-strategi-pencapaian/";

        view = (WebView) rootView.findViewById(R.id.sasaranWeb);

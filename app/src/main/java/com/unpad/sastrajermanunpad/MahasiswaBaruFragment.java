...
public class MahasiswaBaruFragment extends Fragment {

    public MahasiswaBaruFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_mahasiswa_baru, container, false);
        String url = "http://jerman.fib.unpad.ac.id/penerimaan-mahasiswa-baru/alur-penerimaan-mahasiswa-baru-2020/";

        view = (WebView) rootView.findViewById(R.id.mahasiswaBaruWeb);

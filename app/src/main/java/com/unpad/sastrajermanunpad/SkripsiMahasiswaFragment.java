...
public class SkripsiMahasiswaFragment extends Fragment {

    public SkripsiMahasiswaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_skripsi_mahasiswa, container, false);
        String url = "http://jerman.fib.unpad.ac.id/data-skripsi-mahasiswa/";

        view = (WebView) rootView.findViewById(R.id.skripsiMahasiswaWeb);

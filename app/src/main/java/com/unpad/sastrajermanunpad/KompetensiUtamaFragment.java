...
public class KompetensiUtamaFragment extends Fragment {

    public KompetensiUtamaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_kompetensi_utama, container, false);

        String url = "http://jerman.fib.unpad.ac.id/kompetensi-program-studi-sastra-jerman/kompetensi-utama/";

        view = (WebView) rootView.findViewById(R.id.kompetensiUtamaWeb);

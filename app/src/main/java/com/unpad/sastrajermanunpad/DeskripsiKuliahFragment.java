...
public class DeskripsiKuliahFragment extends Fragment {

    public DeskripsiKuliahFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_deskripsi_kuliah, container, false);
        String url = "http://jerman.fib.unpad.ac.id/program/kurikulum/deskripsi-mata-kuliah/";

        view = (WebView) rootView.findViewById(R.id.deskripsiKuliahWeb);

...
public class CapaianFragment extends Fragment {

    public CapaianFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_capaian, container, false);

        String url = "http://jerman.fib.unpad.ac.id/profil/capaian-kegiatan-program-studi/";

        view = (WebView) rootView.findViewById(R.id.capaianWeb);

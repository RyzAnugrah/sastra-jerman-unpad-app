...
public class PrestasiDosenFragment extends Fragment {

    public PrestasiDosenFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_prestasi_dosen, container, false);
        String url = "http://jerman.fib.unpad.ac.id/staf-pengajar/prestasi-dosen/";

        view = (WebView) rootView.findViewById(R.id.prestasiDosenWeb);

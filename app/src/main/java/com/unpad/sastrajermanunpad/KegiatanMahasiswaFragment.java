...
public class KegiatanMahasiswaFragment extends Fragment {

    public KegiatanMahasiswaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_kegiatan_mahasiswa, container, false);
        String url = "http://jerman.fib.unpad.ac.id/program/kegiatan-mahasiswa/";

        view = (WebView) rootView.findViewById(R.id.kegiatanMahasiswaWeb);
